  ...
  case 'lenet'
    switch opts.dataset
      ...
      case 'stl-10'
        ...
        % net.meta.trainOpts.learningRate = [2 * ones(1,10) 0.5*ones(1,20) 0.5:-0.1:0.1 0.1*ones(1,20) 0.05*ones(1,50)]; % big-amir-LR
        net.meta.trainOpts.learningRate = [2 * ones(1,20) 0.5*ones(1,40) 0.1*ones(1,40)]; % big-amir-LR
