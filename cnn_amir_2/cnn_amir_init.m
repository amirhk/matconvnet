...
switch opts.networkArch
  case 'lenet'
    switch opts.dataset
      ...
      case 'stl-10'
        % net.meta.trainOpts.learningRate = [0.01*ones(1,5) 0.005*ones(1,25) 0.001*ones(1,10) 0.0005*ones(1,5) 0.0001*ones(1,5)]; % amir-RL
        % net.meta.trainOpts.learningRate = [2 * ones(1,10) 0.5*ones(1,20) 0.5:-0.1:0.1 0.1*ones(1,20) 0.05*ones(1,50)]; % big-amir-LR %45
        net.meta.trainOpts.learningRate = [2 * ones(1,20) 0.5*ones(1,40) 0.1*ones(1,40)]; % big-amir-LR %42
        % net.meta.trainOpts.learningRate = [2 * ones(1,50)]; % big-amir-LR %42
        % net.meta.trainOpts.learningRate = [0.5*ones(1,20) 0.05*ones(1,15)  0.1:-0.01:0.05 0.05*ones(1,10)]; % javad-LR
        % net.meta.trainOpts.learningRate = [ 0.5*ones(1,20) 0.05*ones(1,15)  0.1:-0.01:0.05 0.05*ones(1,20)  0.01*ones(1,400)]; % full-javad-LR
        net.meta.trainOpts.learningRate = [0.05*ones(1,15) 0.005*ones(1,10) 0.0005*ones(1,25)]; % matconvnet default
    end
  case 'alexnet'
