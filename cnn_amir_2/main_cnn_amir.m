...
% -- == -- == -- == -- == -- == -- == -- == -- == -- == -- == -- == -- == -- ==
  ...
  weightInitSequenceList = { ...
    ...
    ... % {'compRand-from-cifar', 'compRand-from-cifar', 'compRand-from-cifar'}, ...
    ... % {'compRand-from-coil-100', 'compRand-from-coil-100', 'compRand-from-coil-100'}, ... % dumb lol!
    ... % {'compRand-from-mnist', 'compRand-from-mnist', 'compRand-from-mnist'}, ... % dumb lol!
    ... % {'compRand-from-stl-10', 'compRand-from-stl-10', 'compRand-from-stl-10'}, ... % dumb lol!
