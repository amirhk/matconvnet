...
cnn_amir_init('networkType', 'alex-net', 'dataset', 'cifar', 'weightInitType', '2D', 'weightInitSource', 'load')
...
% cnn_amir_init('networkType', 'alex-net', 'dataset', 'cifar', 'weightInitType', '2D', 'weightInitSource', 'gen')
% cnn_amir_init('networkType', 'alex-net', 'dataset', 'cifar', 'weightInitType', '2D-super', 'weightInitSource', 'gen')
cnn_amir_init('networkType', 'alex-net-bottle-neck', 'dataset', 'cifar', 'weightInitType', 'compRand', 'weightInitSource', 'gen')
