...
fh.projectAndSaveImdbThroughNetworkArch('mnist-multi-class-subsampled', 'balanced-38', 'larpV1P0', 2);
fh.projectAndSaveImdbThroughNetworkArch('mnist-multi-class-subsampled', 'balanced-38', 'larpV1P1', 3);
fh.projectAndSaveImdbThroughNetworkArch('mnist-multi-class-subsampled', 'balanced-38', 'larpV3P0', 6);
fh.projectAndSaveImdbThroughNetworkArch('mnist-multi-class-subsampled', 'balanced-38', 'larpV3P1', 7);
fh.projectAndSaveImdbThroughNetworkArch('mnist-multi-class-subsampled', 'balanced-38', 'larpV3P3', 9);

fh.projectAndSaveImdbThroughNetworkArch('mnist',                        'whatever',    'larpV1P0', 2);
fh.projectAndSaveImdbThroughNetworkArch('mnist',                        'whatever',    'larpV1P1', 3);
fh.projectAndSaveImdbThroughNetworkArch('mnist',                        'whatever',    'larpV3P0', 6);
fh.projectAndSaveImdbThroughNetworkArch('mnist',                        'whatever',    'larpV3P1', 7);
fh.projectAndSaveImdbThroughNetworkArch('mnist',                        'whatever',    'larpV3P3', 9);



fh.projectAndSaveImdbThroughNetworkArch('cifar-multi-class-subsampled', 'balanced-38', 'larpV1P0', 2);
fh.projectAndSaveImdbThroughNetworkArch('cifar-multi-class-subsampled', 'balanced-38', 'larpV1P1', 3);
fh.projectAndSaveImdbThroughNetworkArch('cifar-multi-class-subsampled', 'balanced-38', 'larpV3P0', 6);
fh.projectAndSaveImdbThroughNetworkArch('cifar-multi-class-subsampled', 'balanced-38', 'larpV3P1', 7);
fh.projectAndSaveImdbThroughNetworkArch('cifar-multi-class-subsampled', 'balanced-38', 'larpV3P3', 9);

fh.projectAndSaveImdbThroughNetworkArch('cifar',                        'whatever',    'larpV1P0', 2);
fh.projectAndSaveImdbThroughNetworkArch('cifar',                        'whatever',    'larpV1P1', 3);
fh.projectAndSaveImdbThroughNetworkArch('cifar',                        'whatever',    'larpV3P0', 6);
fh.projectAndSaveImdbThroughNetworkArch('cifar',                        'whatever',    'larpV3P1', 7);
fh.projectAndSaveImdbThroughNetworkArch('cifar',                        'whatever',    'larpV3P3', 9);



fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white-multi-class-subsampled', 'balanced-38', 'larpV1P0', 2);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white-multi-class-subsampled', 'balanced-38', 'larpV1P1', 3);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white-multi-class-subsampled', 'balanced-38', 'larpV3P0', 6);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white-multi-class-subsampled', 'balanced-38', 'larpV3P1', 7);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white-multi-class-subsampled', 'balanced-38', 'larpV3P3', 9);

fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white',                        'whatever',    'larpV1P0', 2);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white',                        'whatever',    'larpV1P1', 3);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white',                        'whatever',    'larpV3P0', 6);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white',                        'whatever',    'larpV3P1', 7);
fh.projectAndSaveImdbThroughNetworkArch('cifar-no-white',                        'whatever',    'larpV3P3', 9);



fh.projectAndSaveImdbThroughNetworkArch('coil-100',                        'whatever',    'larpV1P0', 2);
fh.projectAndSaveImdbThroughNetworkArch('coil-100',                        'whatever',    'larpV1P1', 3);
fh.projectAndSaveImdbThroughNetworkArch('coil-100',                        'whatever',    'larpV3P0', 6);
fh.projectAndSaveImdbThroughNetworkArch('coil-100',                        'whatever',    'larpV3P1', 7);
fh.projectAndSaveImdbThroughNetworkArch('coil-100',                        'whatever',    'larpV3P3', 9);
