...
for i = 1:25
  ...
  subplot(5, 6, 1 + 6 * (2 - 1)), imagesc(sigma_smoothed_2),                                         title('sigma smoothed 2');
  subplot(5, 6, 2 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_smoothed_2, 1), 5, 5)),         title('sigma smoothed var / 1');
  subplot(5, 6, 3 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_smoothed_2 / 10, 1), 5, 5)),    title('sigma smoothed var / 10');
  subplot(5, 6, 4 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_smoothed_2 / 100, 1), 5, 5)),   title('sigma smoothed var / 100');
  subplot(5, 6, 5 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_smoothed_2 / 1000, 1), 5, 5)),  title('sigma smoothed var / 1000');
  subplot(5, 6, 6 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_smoothed_2 / 10000, 1), 5, 5)), title('sigma smoothed var / 10000');

  subplot(5, 6, 1 + 6 * (3 - 1)), imagesc(sigma_smoothed_3),                                         title('sigma smoothed 3');
  subplot(5, 6, 2 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_smoothed_3, 1), 5, 5)),         title('sigma smoothed var / 1');
  subplot(5, 6, 3 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_smoothed_3 / 10, 1), 5, 5)),    title('sigma smoothed var / 10');
  subplot(5, 6, 4 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_smoothed_3 / 100, 1), 5, 5)),   title('sigma smoothed var / 100');
  subplot(5, 6, 5 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_smoothed_3 / 1000, 1), 5, 5)),  title('sigma smoothed var / 1000');
  subplot(5, 6, 6 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_smoothed_3 / 10000, 1), 5, 5)), title('sigma smoothed var / 10000');

  subplot(5, 6, 1 + 6 * (4 - 1)), imagesc(sigma_smoothed_4),                                         title('sigma smoothed 4');
  subplot(5, 6, 2 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_smoothed_4, 1), 5, 5)),         title('sigma smoothed var / 1');
  subplot(5, 6, 3 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_smoothed_4 / 10, 1), 5, 5)),    title('sigma smoothed var / 10');
  subplot(5, 6, 4 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_smoothed_4 / 100, 1), 5, 5)),   title('sigma smoothed var / 100');
  subplot(5, 6, 5 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_smoothed_4 / 1000, 1), 5, 5)),  title('sigma smoothed var / 1000');
  subplot(5, 6, 6 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_smoothed_4 / 10000, 1), 5, 5)), title('sigma smoothed var / 10000');

  subplot(5, 6, 1 + 6 * (5 - 1)), imagesc(sigma_smoothed_5),                                         title('sigma smoothed 5');
  subplot(5, 6, 2 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_smoothed_5, 1), 5, 5)),         title('sigma smoothed var / 1');
  subplot(5, 6, 3 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_smoothed_5 / 10, 1), 5, 5)),    title('sigma smoothed var / 10');
  subplot(5, 6, 4 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_smoothed_5 / 100, 1), 5, 5)),   title('sigma smoothed var / 100');
  subplot(5, 6, 5 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_smoothed_5 / 1000, 1), 5, 5)),  title('sigma smoothed var / 1000');
  subplot(5, 6, 6 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_smoothed_5 / 10000, 1), 5, 5)), title('sigma smoothed var / 10000');
  pause(0.05);
end
...
for i = 1:2
  ...
  subplot(5, 6, 2 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_anisodiffed_1, 1), 5, 5)),         title('sigma anisodiffed var / 1');
  subplot(5, 6, 3 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_anisodiffed_1 / 10, 1), 5, 5)),    title('sigma anisodiffed var / 10');
  subplot(5, 6, 4 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_anisodiffed_1 / 100, 1), 5, 5)),   title('sigma anisodiffed var / 100');
  subplot(5, 6, 5 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_anisodiffed_1 / 1000, 1), 5, 5)),  title('sigma anisodiffed var / 1000');
  subplot(5, 6, 6 + 6 * (2 - 1)), imagesc(reshape(mvnrnd(mu_1, sigma_anisodiffed_1 / 10000, 1), 5, 5)), title('sigma anisodiffed var / 10000');

  subplot(5, 6, 1 + 6 * (3 - 1)), imagesc(sigma_anisodiffed_2),                                         title('sigma anisodiffed 2');
  subplot(5, 6, 2 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_anisodiffed_2, 1), 5, 5)),         title('sigma anisodiffed var / 1');
  subplot(5, 6, 3 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_anisodiffed_2 / 10, 1), 5, 5)),    title('sigma anisodiffed var / 10');
  subplot(5, 6, 4 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_anisodiffed_2 / 100, 1), 5, 5)),   title('sigma anisodiffed var / 100');
  subplot(5, 6, 5 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_anisodiffed_2 / 1000, 1), 5, 5)),  title('sigma anisodiffed var / 1000');
  subplot(5, 6, 6 + 6 * (3 - 1)), imagesc(reshape(mvnrnd(mu_2, sigma_anisodiffed_2 / 10000, 1), 5, 5)), title('sigma anisodiffed var / 10000');

  subplot(5, 6, 1 + 6 * (4 - 1)), imagesc(sigma_anisodiffed_3),                                         title('sigma anisodiffed 3');
  subplot(5, 6, 2 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_anisodiffed_3, 1), 5, 5)),         title('sigma anisodiffed var / 1');
  subplot(5, 6, 3 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_anisodiffed_3 / 10, 1), 5, 5)),    title('sigma anisodiffed var / 10');
  subplot(5, 6, 4 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_anisodiffed_3 / 100, 1), 5, 5)),   title('sigma anisodiffed var / 100');
  subplot(5, 6, 5 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_anisodiffed_3 / 1000, 1), 5, 5)),  title('sigma anisodiffed var / 1000');
  subplot(5, 6, 6 + 6 * (4 - 1)), imagesc(reshape(mvnrnd(mu_3, sigma_anisodiffed_3 / 10000, 1), 5, 5)), title('sigma anisodiffed var / 10000');

  subplot(5, 6, 1 + 6 * (5 - 1)), imagesc(sigma_anisodiffed_4),                                         title('sigma anisodiffed 4');
  subplot(5, 6, 2 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_anisodiffed_4, 1), 5, 5)),         title('sigma anisodiffed var / 1');
  subplot(5, 6, 3 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_anisodiffed_4 / 10, 1), 5, 5)),    title('sigma anisodiffed var / 10');
  subplot(5, 6, 4 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_anisodiffed_4 / 100, 1), 5, 5)),   title('sigma anisodiffed var / 100');
  subplot(5, 6, 5 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_anisodiffed_4 / 1000, 1), 5, 5)),  title('sigma anisodiffed var / 1000');
  subplot(5, 6, 6 + 6 * (5 - 1)), imagesc(reshape(mvnrnd(mu_4, sigma_anisodiffed_4 / 10000, 1), 5, 5)), title('sigma anisodiffed var / 10000');
  pause(0.05);
end
