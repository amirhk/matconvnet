% --------------------------------------------------------------------
function imdb = constructMnistUnbalancedTwoClassImdb(data_dir, network_arch)
% --------------------------------------------------------------------
  ...
  if strcmp(network_arch, 'mnistnet')
    data = single(reshape(cat(3, x1, x2),28,28,1,[]));
  elseif strcmp(network_arch, 'lenet')
  ...
  subsampled_data_ones_indices = randsample(size(data_ones, 4), floor(size(data_ones, 4) / 200));
