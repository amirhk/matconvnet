...
% fc_plus_1 = load(fullfile(dataDir, subDataDir, 'cifar-alex-net-30-Oct-2016-08-18-17-GPU2', epochFile)); fprintf('\t%d', i); i = i + 1;
% fc_only = load(fullfile(dataDir, subDataDir, 'cifar-alex-net-30-Oct-2016-10-05-26-GPU2', epochFile)); fprintf('\t%d', i); i = i + 1;
weight_decay_0 = load(fullfile(dataDir, subDataDir, 'cifar-alex-net-28-Oct-2016-18-24-19-GPU2', epochFile)); fprintf('\t%d', i); i = i + 1;
weight_decay_1e_4 = load(fullfile(dataDir, subDataDir, 'cifar-alex-net-31-Oct-2016-12-28-55-GPU1', epochFile)); fprintf('\t%d', i); i = i + 1;
weight_decay_1e_3 = load(fullfile(dataDir, subDataDir, 'cifar-alex-net-31-Oct-2016-12-29-09-GPU2', epochFile)); fprintf('\t%d', i); i = i + 1;
fprintf('\nDone!');
